...
public class TieredArrowEntity extends AbstractArrow {
    ...
    public TieredArrowEntity(double x, double y, double z, Level level, ArrowTier tier) {
        super(Services.PLATFORM.entityFromTier(tier), x, y, z, level, getPickupItemFromTier(tier), null);
        this.tier = tier;
    ...
    public TieredArrowEntity(LivingEntity livingEntity, Level level, ArrowTier tier) {
        super(Services.PLATFORM.entityFromTier(tier), livingEntity, level, getPickupItemFromTier(tier), null);
        this.tier = tier;
        this.setVariant(tier);
        this.setBaseDamage(this.getBaseDamage() + this.tier.bonusDamage());
    }
    ...
    protected static @NotNull ItemStack getPickupItemFromTier(ArrowTier tier) {
        return new ItemStack(Services.PLATFORM.itemFromTier(tier));
    }
