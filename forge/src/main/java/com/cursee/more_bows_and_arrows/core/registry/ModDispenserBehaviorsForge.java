...
public class ModDispenserBehaviorsForge {
    ...
    private static void mappedArrow(Map<Item, AbstractProjectileDispenseBehavior> map, Supplier<Item> item, ArrowTier tier) {
        map.put(item.get(), new AbstractProjectileDispenseBehavior() {
            @Override
